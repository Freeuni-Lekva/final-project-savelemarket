...
<div class="add-location-inputs">
    <form action="/add-location" method="post" class="add-locations-form">
        ...
        <input type="submit" value="დამატება" class="registration_btn_1"/>
            <%
                if(request.getAttribute("location-already-exists") != null){
    ...
    <form action="/admin-resets" method="post" class="logout-form">
        <li>
